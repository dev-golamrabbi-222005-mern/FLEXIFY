...
const LEVELS: { id: Level; label: string; emoji: string; desc: string; color: string }[] = [
  {
    ...
    label: "Beginner",
    emoji: "🌱",
    desc: "New to working out. Light weights, basic movements. Can do 0-10 push-ups easily.",
    color: "#22c55e",
  },
  {
    id: "intermediate",
    label: "Intermediate",
    emoji: "⚡",
    desc: "Some experience. Ready to push harder. Can do 10-20 push-ups easily.",
    color: "var(--primary)",
  },
  {
    id: "advance",
    label: "Advanced",
    emoji: "🔥",
    desc: "Experienced athlete. Max intensity. Can do 20+ push-ups easily.",
    color: "#ef4444",
  },
];
