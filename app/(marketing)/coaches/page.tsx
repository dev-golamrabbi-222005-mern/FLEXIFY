...
const CoachesPage = () => {
  ...
  if (isError) return <div className="flex items-center justify-center min-h-screen font-bold text-red-500">Error loading coaches data.</div>;

  return (
    <div className="min-h-screen px-6 py-12 mx-auto max-w-7xl">
